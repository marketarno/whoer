...
<head>
        ...
        <meta http-equiv="refresh" content="5; url=https://who.sprinklr.com/" />
...
<script type="text/javascript">
    ...
    {
            User.UpdateLogo('', "Your WHO Subscription is Successful.", true);

        var signoutStatusMessage = $('#SignOutStatusMessage');
        signoutStatusMessage.text("Thanks for helping us keep you informed on Health Safety News during this Pandemic.");
            ...
            <div class="middle">
                <div class="inner">
                    ...
                    <div role="alert" aria-live="assertive">
                        <div id="login_workload_logo_text" class="row text-title" role="heading">Hang on a moment while we process your subscription.</div>
